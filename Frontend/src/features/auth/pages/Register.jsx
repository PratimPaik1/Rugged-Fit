...
import registerBG from "../../assets/ruggedfit_hero.png";
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Buyer registration explicitly sends isSeller: false (default, but good to be explicit)
            await handleRegister({ ...payload, isSeller: false });
    ...
    return (
        <AuthLayout
            ...
            subtitle="Join the premier fitness marketplace"
